...
export default function WhyUs() {
  return (
    <section id="why-us" style={{ backgroundColor: '#020B18' }} className="py-28">
          ...
          <div className="grid gap-8">
            {pillars.map((p) => (
              <div key={p.number} className="flex gap-6">
                <span className="font-display font-bold text-teal-600/25 text-2xl leading-none pt-1 min-w-[2.5rem]">
                  {p.number}
                </span>
                <div>
